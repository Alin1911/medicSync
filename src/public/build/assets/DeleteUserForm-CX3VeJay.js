            ...
            function (a, c) {
                ...
                for (let p of v)
                    if (
                        ...
                        return;
                return (
                    !Pt(d, Se.Loose) && d.tabIndex !== -1 && a.preventDefault(),
                    o.current(a, d)
                );
            },
            [o, t],
...
let A = De(() => new Map(), {
    PUSH(e, t) {
        ...
        let r =
            (n = this.get(e)) != null
                ? n
                : { doc: e, count: 0, d: K(), meta: new Set() };
...
function Vt(e, t) {
    let n = S(t),
        ...
        u = $();
    return r
        ? m.createElement(Wt, { ...l, ownerDocument: o, ref: n })
        : u({
              ourProps: { ref: n },
              theirProps: l,
              slot: {},
                ...
                children: h.jsxs('form', {
                    ...
                    children: [
                        ...
                        h.jsxs('div', {
                            ...
                            children: [
                                h.jsx(Pn, { onClick: f, children: 'Cancel' }),
                                h.jsx(be, {
                                    className: 'ms-3',
                                    disabled: i,
                                    children: 'Delete Account',
